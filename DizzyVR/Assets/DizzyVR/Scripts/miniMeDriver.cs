...
public class miniMeDriver : MonoBehaviour
{
    ...
    private void Move()
    {
        ...
        miniMe.transform.position += (movement + strafe);
        miniMe.transform.position = new Vector3(transform.position.x, fixY, transform.position.z);
    }
